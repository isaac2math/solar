...
########################################################################
'''
this class is used for plotting the result of simulation 3, Section 4
...
class simul_plot:
    ...
    def __init__(self, sample_size, n_dim, n_info, coef_1, coef_2, n_repeat, num_rep, step_size, rnd_seed):
    ...
    #compute 200 repeats of solar vs cv-lars-lasso and cv-cd
        ...
        for i in tqdm(range(self.num_rep)):
            ...
            if self.coef_t > 1:
                ...
                print("Warning: this simulation and plotting classes is composed only for the cases where irrepresentable condition is satistied. When irrepresentable condition is violated, the ranking of variables in plots and their probaility will be in error and misordered. As such, plz add the optional backwards elimation as suggested in solar algorithm and rewrite all plotting classes.")
    ...
    #the histogram of number of variables selected : solar vs competitors
        ...
        if self.coef_t <= 1:
            ...
            #output it into pdf
            f11.savefig("sparsity_plot_ic_"+str(self.coef_1)+"_vs_CVcd.pdf", bbox_inches='tight')
            ...
            #output it into pdf
            f1.savefig("sparsity_plot_ic_"+str(self.coef_1)+"_vs_CVlars.pdf", bbox_inches='tight')
    ...
    #histogram plot of c* of solar in 200 repeatss
        ...
        if self.coef_t <= 1:
            ...
            f2.savefig("q-values_plot_ic_"+str(self.coef_1)+".pdf", bbox_inches='tight')
    ...
    #bar plot: probability of solar/cv-lars-lasso/cv-cd selecting each variable (all 5 informative variables; redundant variables (of top 35 probability))
        ...
        if self.coef_t <= 1:
            ...
            f4.savefig("acc_plot_top" + str(num_var_to_plot) + "_ic_" + str(self.coef_1) + "_" + str(print_true) + "_solar.pdf", bbox_inches='tight')
            ...
            #output it as pdf file
            f44.savefig("acc_plot_top" + str(num_var_to_plot) + "_ic_" + str(self.coef_1) + "_" + str(print_true) + "_lars.pdf", bbox_inches='tight')
            ...
            #output it as pdf file
            f444.savefig("acc_plot_top" + str(num_var_to_plot) + "_ic_" + str(self.coef_1) + "_" + str(print_true) + "_cd.pdf", bbox_inches='tight')
    ...
    #since we only boxplot olar regression coefficients (of top 15 means), we do the ranking again
        ...
        if self.coef_t <= 1:
            ...
            #output it as pdf file
            f3.savefig("solar_vari_plot_top"+str(num_var_to_plot)+"_ic_"+str(self.coef_1)+".pdf", bbox_inches='tight')
...
if __name__ == '__main__':
    ...
    trial = simul_plot(sample_size, n_dim, n_info, coef_1, coef_2, n_repeat, num_rep, step_size, rnd_seed)
