...
'''
this class is used for plotting the result of the Demonstration Simulation in Section 3:
...
class one_shot_simul:
    ...
    def __init__(self, sample_size, n_dim, n_info, n_repeat, step_size, rnd_seed):
    ...
    ##plot the corresponding test error of each value of c in its tuning (grid search)
