...
please note that this package is almost identical with "bolasso.py". The only difference is that 
    1. in "bolasso.py", we don't have to manually set a parallel scheme. We use the default sklearn parallel
    2. in this file, we design a high-level parallel scheme ourselves.
