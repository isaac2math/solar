...
##########################################
'''
this class is used to compute average runtime of each algorithm under customized Joblib parallel scheme:
...
class simul_func:
    ...
    #compute 200 repeats of bsolar for average runtime
    ...
    def simul_bolasso(self):
        ...
        for i in tqdm(range(self.num_rep)):
            ...
            #4b. compute bolasso
            bsolar_coef_H, bsolar_coef_S, Qc_list, Q_opt_c_H, Q_opt_c_S = trial6.fit()
