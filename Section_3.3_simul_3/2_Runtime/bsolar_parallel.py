...
'''
this class is used to demonstrate the performance of boostrap solar (bsolar) via Joblib parallel computation

please note that this file is identical to bsolar.py except the subsample selection frequency estimation (step 2, line 97 - 141), where we use customized Joblib parallel scheme instead.
