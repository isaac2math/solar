...
# For recent version of Scikit-learn: since the class 'Lars' may rely on the Cholesky decomposition and hence may have potential convergence warnings in high dimensional data (p is much larger than n), we input the following commmand to skip the convergence warning.
...
please note that this file is identical to "solar_parallel.py" except the average solution path estimation (step 2, line 97 - 130 of this file), where we use a sequential for-loop instead.
