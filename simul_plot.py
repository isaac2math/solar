...
class simul_plot:
    ...
    #the histogram of number of variables selected : solar vs competitors
        ...
        #output it as pdf
        f11.savefig("sparsity_plot_n_"+str(self.sample_size)+"_vs_CVcd.pdf", bbox_inches='tight')
        ...
        #output it into pdf
        f1.savefig("sparsity_plot_n_"+str(self.sample_size)+"_vs_CVlars.pdf", bbox_inches='tight')
    ...
    #histogram plot of c* of solar in 200 repeats
        ...
        f2.savefig("q-values_plot_n_"+str(self.sample_size)+".pdf", bbox_inches='tight')
    ...
    #bar plot: probability of solar/cv-lars-lasso/cv-cd selecting each variable (all 5 informative variables; redundant variables (of top 35 probability))
        ...
        f4.savefig("acc_plot_top" + str(num_var_to_plot) + "_n_" + str(self.sample_size) + "_" + str(print_true) + "_solar.pdf", bbox_inches='tight')
        ...
        #output it as pdf file
        f44.savefig("acc_plot_top" + str(num_var_to_plot) + "_n_" + str(self.sample_size) + "_" + str(print_true) + "_lars.pdf", bbox_inches='tight')
        ...
        #output it as pdf file
        f444.savefig("acc_plot_top" + str(num_var_to_plot) + "_n_" + str(self.sample_size) + "_" + str(print_true) + "_cd.pdf", bbox_inches='tight')
    ...
    #since we only boxplot olar regression coefficients (of top 15 means), we do the ranking again
        ...
        plt.xticks(solar_x_axi[0 : num_var_to_plot], solar_final_label[:num_var_to_plot], rotation='vertical')
        plt.title('The boxplot of solar regression coefficient')
        plt.tick_params(axis='both', which='major', labelsize=16)
        ...
        f3.savefig("solar_vari_plot_top"+str(num_var_to_plot)+"_n_"+str(self.sample_size)+".pdf", bbox_inches='tight')
